...
import { getRentalAgencyById } from 'apiSdk/rental-agencies';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Rental Agency Detail View
          </Text>
          {hasAccess('rental_agency', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/rental-agencies/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('car', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/cars/create?rental_agency_id=${data?.id}`}>
